          ...
          <div class="d-flex align-items-center justify-content-between">
            <div>
              <h2 class="mb-1 d-flex align-items-center">
                <span class="mdi mdi-24px me-2 mdi-page-next"></span>
                PaginationControl
                <small class="badge ms-2 bg-success">Vue Component</small>
              </h2>
              <p class="text-muted mb-0">Comprehensive pagination component with page size options</p>
            </div>
            <div class="text-end">
              <small class="text-muted d-block">Category: Navigation</small>
              <small class="text-muted d-block">File: PaginationControl.vue</small>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="tab-content">
      ...
      <div v-show="activeTab === 'overview'">
        <div class="row">
          <div class="col-12">
            <h4>Purpose</h4>
            <p>Comprehensive pagination component with page size options</p>

            <h4>Integration</h4>
            <div class="bg-light p-3 rounded">
              <h6>Import Statement:</h6>
              <pre><code>import PaginationControl from './components/common/PaginationControl.vue'</code></pre>
...
<script>
export default {
  name: 'PaginationControlComponentPage',
  data() {
    return {
      activeTab: 'overview'
    }
